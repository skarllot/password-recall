# Contributing to Raiqub Password Recall

We take Pull Requests!

## Before you send Pull Request

1. Contact the contributors via the [Github Issue](https://github.com/skarllot/password-recall/issues/new/choose) to make sure that this is issue or bug should be handled with proposed way. Send details of your case and explain the details of the proposed solution.
...
6. When you're ready to create the [Pull Request on GitHub](https://github.com/skarllot/password-recall/compare).
...
By contributing to Raiqub Password Recall:
